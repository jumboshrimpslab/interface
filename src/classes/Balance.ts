...
export default class Balance {
  ...
  static Native(valueAtomicUnits: BN) {
    return new Balance(AssetType.Native(), valueAtomicUnits);
  }
  ...
  toStringUnrounded(): string {
    return this.valueBaseUnits()
      .toDecimalPlaces(this.assetType.numberOfDecimals, Decimal.ROUND_DOWN)
      .toString();
  }
